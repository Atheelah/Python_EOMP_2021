...
class Bank:
    def __init__(self, master):
        ...
        self.bankEnt = OptionMenu(self.banking, self.default_var, "ABSA Bank", "Capitec Bank", 'Standard Bank', 'NedBank')
...
# defining my CLEAR BUTTON with OOP
    def clear(self):

        self.holderEnt.delete(0, END)
        self.default_var.set("Select Bank")
